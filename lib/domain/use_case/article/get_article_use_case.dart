...
class GetArticleUseCase extends FutureUseCase<String, ArticleEntity> {
  @override
  Future<ArticleEntity> run(String input) async {
    return injector.get<ArticleRepository>().getArticeById(input);
  }
}
